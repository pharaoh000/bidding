        ...
        <div class="row center">
            ...
            <div class="col-md-6 col-md-offset-3">
                 <div class="socil-media">
                   <ul>
                   <!--{{Setting::get('store_facebook_link','https://www.facebook.com/cabbookingonline')}}-->
                   <!--{{Setting::get('store_twitter_link','https://www.instagram.com/6ixtaxi/')}}-->
                                    <li><a target="_blank" href="https://www.facebook.com/cabbookingonline"><i class="fa fa-3x fa-facebook"></i></a></li>
                                    <li><a target="_blank" href="https://www.instagram.com/6ixtaxi/"><i class="fa fa-3x fa-instagram"></i></a></li>
                                </ul>
                 </div>
             </div>
    </div>
                        ...
                        <div class="container">
                        <div class="row" id="footer_style">
                            <div class="col-md-4 col-sm-4 col-xs-6 site_info">
                                <ul>
                                    <li>{{Setting::get('contact_address','#')}}</li><br>
                                    <li>Email:  {{Setting::get('contact_email','#')}}</li><br>
                                    <li>Contact:  {{Setting::get('contact_number','#')}}</li>
                                </ul>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-6">
                                <ul>
                                    <li><a href="{{url('Communityguidelines')}}">Community Guidelines</a></li>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-6">                        
                                <h5>Connect Us</h5>
                                <ul class="social">
                                    <li><a href="{{Setting::get('store_facebook_link','https://www.facebook.com/cabbookingonline')}}"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="{{Setting::get('store_twitter_link','https://www.instagram.com/6ixtaxi/')}}"><i class="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        </div>
