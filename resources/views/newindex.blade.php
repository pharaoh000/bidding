...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p>Getting your day started shouldn’t be hard. We can get you wherever, whenever. Learn how to ride with the {{ Setting::get('site_title', '6ixTaxi')  }} app. </p>
...
<div class="row gray-section pad-60">
    <div class="container">                
        <div class="col-md-6">
            ...
            <div class="title-divider"></div>
            <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on {{ Setting::get('site_title', '6ixTaxi') }} for a ride—no reservations needed.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center"> 
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>Request everyday cars at everyday prices. Choose your style depending on your mood. </p>
            <!--<p>You can always request everyday cars at everyday prices. But sometimes you need a bit more space. Or you want to go big on style. With {{ Setting::get('site_title', '6ixTaxi') }}, the choice is yours.</p>-->
            <a class="content-more more-btn" href="{{url('/ride')}}">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <h2>Everyday people going your way </h2>
            <!--<h2>They’re people like you, going your way</h2>-->
            <div class="title-divider"></div>
            <p>What makes the {{ Setting::get('site_title', '6ixTaxi') }} experience truly great are the people behind the wheel. They are mothers, fathers, students, teachers, veterans, neighbours and friends. Our partners drive their own car- on their own schedule in cities big and small to provide you with the excellent service that we pride ourselves on. </p>
            <!--<p>What makes the {{ Setting::get('site_title', '6ixTaxi') }} experience truly great are the people behind the wheel. They are mothers and fathers. Students and teachers. Veterans. Neighbors. Friends. Our partners drive their own cars—on their own schedule—in cities big and small. Which is why more than one million people worldwide have signed up to drive.</p>-->
            <a class="content-more more-btn" href="{{ url('/drive') }}">WHY DRIVE WITH {{ Setting::get('site_title', '6ixTaxi')  }} <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>A city with {{ Setting::get('site_title', '6ixTaxi') }} has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it. </p>
            <!--<p>A city with {{ Setting::get('site_title', '6ixTaxi') }} has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it.</p>-->
...
<div class="row find-city">
    <div class="container pad-60 content-block center">
        <h2>{{ Setting::get('site_title','6ixTaxi') }} is in Your City</h2>
        <div class="row">
