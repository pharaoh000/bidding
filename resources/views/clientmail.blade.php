    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div style="border-top:solid #9a9797 1px;border-bottom:solid #9a9797 1px;">
            ...
            <p><strong>User : {{Setting::get('store_link_ios_user','#')}}</p>
            <p><strong>Provider : {{Setting::get('store_link_ios_provider','#')}}</p>
        </div>    

        <div style="border-top:solid #9a9797 1px;">
            <p><strong>Android App Details : </strong></p>
            <p><strong>User : {{Setting::get('store_link_android_user','#')}}</p>
            <p><strong>Provider : {{Setting::get('store_link_android_provider','#')}}</p>
        </div>
      </div>
