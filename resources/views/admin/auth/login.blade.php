                ...
                <div id="userform">
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li @if ($errors->has('login_type') && $errors->first('login_type') == 'fleet')  class="active" @endif><a href="#fleet" role="tab" data-toggle="tab">Fleet</a></li>
                         ...
                         <li @if ($errors->has('login_type') && $errors->first('login_type') == 'corporate')  class="active" @endif><a href="#corporate" role="tab" data-toggle="tab">Corporate</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'account')  active @endif in" id="account">
                         ...
                         <!-- Corporate -->
                        <div class="tab-pane fade @if ($errors->has('login_type') && $errors->first('login_type') == 'corporate')  active @endif in" id="corporate">
                            <h2 class="text-uppercase text-center">Sign In</h2>
                            <form id="login" role="form" method="POST" action="{{ url('/corporate/login') }}">
                             {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Corporate Administrator E-mail<span class="req">*</span> </label>
