		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-crown"></i></span>
					<span class="s-text">@lang('admin.include.corporate')</span>
				</a>
				<ul> 
					<li><a href="{{ route('admin.corporate.index') }}">@lang('admin.include.list_corporates')</a></li>  
					<li><a href="{{ route('admin.corporate.create') }}">@lang('admin.include.add_new_corporate')</a></li> 
				</ul>
			</li>
			...
			{{--<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-crown"></i></span>
					<span class="s-text">@lang('admin.include.corusers')</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.corporateusers.index') }}">
					@lang('admin.include.cor_list_users')</a></li>
					<li><a href="{{ route('admin.corporateusers.create') }}">@lang('admin.include.cor_add_new_user')</a></li>
					<li><a href="{{ url('/admin/corhistory') }}">
					@lang('admin.include.request_history')</a></li>
				</ul>
			</li>--}}
