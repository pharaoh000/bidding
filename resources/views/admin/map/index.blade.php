...
<script>
    ...
    function addMarkerToMap(element, index) {
        let carNo = element.service ? element.service.service_number : "";
        marker = new google.maps.Marker({
            ...
            id: element.id,
            map: map,
            title: element.first_name + " " +element.last_name + ", " + element.mobile + ", " +  carNo,
        ...
        google.maps.event.addListener(marker, 'click', function() {
            window.location.href = '/admin/providers/search?first-name=' + element.first_name + '&last-name=' + element.last_name;
        });
    }
</script>
