<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li>
				<a href="{{ route('dispatcher.providers.status') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-user"></i></span>
					<span class="s-text">Provider Status</span>
				</a>
			</li>
			<li>
			...
			<li>
				<a href="{{ route('dispatcher.ride.statement.monthly') }}" class="waves-effect waves-light">
